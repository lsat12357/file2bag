    ...
    CCLICENSES =
      [
       { :alt => "CC by-nc-nd 3.0 US",
         ...
         { :alt => "CC by-nc-nd 4.0 US",
         :uri => RDF::URI("http://creativecommons.org/licenses/by-nc-nd/4.0/us"),
         :name => "Creative Commons Attribution-Noncommercial-No Derivative Works 4.0 United States License" },
         { :alt => "CC by-sa 4.0 US",
         :uri => RDF::URI("http://creativecommons.org/licenses/by-sa/4.0/us"),
         :name => "Creative Commons Attribution-ShareAlike 4.0 United States License" },
      ]
